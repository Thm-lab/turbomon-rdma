        ...
        while ((ret = ibv_poll_cq(cq, 1, &wc)) == 1) {
            ...
            switch (wc.opcode) {
                ...
                case IBV_WC_RDMA_READ:
                    ...
                    //                    memcpy(&sketch_data[0], rdma_buf,
                    //                    remote_len); for (int i = 0; i <
                    //                    (remote_len / sizeof(std::pair<int,
                    //                    int>)); i++){
                    //                        std::cout << sketch_data[i].first
                    //                        << " " << sketch_data[i].second <<
                    //                        std::endl;
                    //                    }
    ...
    while (true) {
        ...
        switch (event->event) {
            case RDMA_CM_EVENT_ADDR_RESOLVED:
                ...
                //                if (ret){
                //                    std::cerr << "rdma_resolve_route error: "
